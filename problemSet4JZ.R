...
# create new variable with electoral votes for the first runner up
electoralCollege$RunnerUpEC <- str_extract(electoralCollege$"Other major candidates",
                                               "\\(?[0-9]+\\)?")

# create new variable with electoral votes for all the other major candidates
electoralCollege$OtherCandEC <- str_extract_all(electoralCollege$"Other major candidates",
                                               "\\(?[0-9]+\\)?")
